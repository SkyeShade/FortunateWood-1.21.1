...
public class FortunateWood {
    ...
    public FortunateWood(IEventBus modEventBus, ModContainer modContainer) {
        ...
        // Note that this is necessary if and only if we want *this* class (FortunateWood) to respond directly to events.
        ...
        ModLootModifiers.GLM_CODECS.register(modEventBus);  // <-- required
